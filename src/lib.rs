...
impl WebForm{
    pub fn convert_to_big_box(&self) -> Option<BigBox> {
        BigBox::new(vec!(self.cell_0, self.cell_1, self.cell_2, self.cell_3, self.cell_4, self.cell_5, 
        self.cell_6, self.cell_7, self.cell_8, self.cell_9, self.cell_10, self.cell_11, self.cell_12, 
        self.cell_13, self.cell_14, self.cell_15, self.cell_16, self.cell_17, self.cell_18, self.cell_19, 
        self.cell_20, self.cell_21, self.cell_22, self.cell_23, self.cell_24, self.cell_25, self.cell_26, 
        self.cell_27, self.cell_28, self.cell_29, self.cell_30, self.cell_31, self.cell_32, self.cell_33, 
        self.cell_34, self.cell_35, self.cell_36, self.cell_37, self.cell_38, self.cell_39, self.cell_40, 
        self.cell_41, self.cell_42, self.cell_43, self.cell_44, self.cell_45, self.cell_46, self.cell_47, 
        self.cell_48, self.cell_49, self.cell_50, self.cell_51, self.cell_52, self.cell_53, self.cell_54, 
        self.cell_55, self.cell_56, self.cell_57, self.cell_58, self.cell_59, self.cell_60, self.cell_61, 
        self.cell_62, self.cell_63, self.cell_64, self.cell_65, self.cell_66, self.cell_67, self.cell_68, 
        self.cell_69, self.cell_70, self.cell_71, self.cell_72, self.cell_73, self.cell_74, self.cell_75, 
        self.cell_76, self.cell_77, self.cell_78, self.cell_79, self.cell_80))
    }
}